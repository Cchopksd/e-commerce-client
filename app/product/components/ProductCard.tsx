...
export default function ProductCard({ product, isFavorite }: ProductCardProps) {
  ...
  return (
    <a
      ...
      className={`group relative flex w-full flex-col overflow-hidden rounded-lg border  bg-white shadow-sm 
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="flex w-full items-end justify-end p py-2">
