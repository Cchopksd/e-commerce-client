...
export default function Page() {
  ...
  return (
    <div className="w-full h-full min-h-[90dvh] max-w-[1440px] m-auto flex justify-center items-center">
      <div className="flex flex-col w-full max-w-xl m-auto space-y-8 shadow-xl p-6">
